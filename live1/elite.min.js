...
(c[b].Id_Ecart1erCategorie=c[b].Id_Ecart1erCategorie.substr(1)));"undefined"!=typeof c[b].Id_TpsCumule&&"-"!=c[b].Id_TpsCumule&&("00:"==c[b].Id_TpsCumule.toString().substring(0,3)&&(c[b].Id_TpsCumule=c[b].Id_TpsCumule.substr(3)),"0"==c[b].Id_TpsCumule.toString().substring(0,1)&&c[b].Id_TpsCumule.includes(":")&&(c[b].Id_TpsCumule=c[b].Id_TpsCumule.substr(1)));if(c[b].Id_TpsTour1&&1==d)for(h=f=C;-1<h;h--)if(c[b]["Id_TpsTour"+h]&&"-"!=c[b]["Id_TpsTour"+h]||0==h){e=h;for(h=1;h<=f;h++)c[b]["Id_lap"+h]=
0<e?c[b]["Id_TpsTour"+e]:"-",e--;h=-1}1==v&&"yes"==useCategory&&0==D&&(G=c[b].Id_Categorie.includes("\u05de\u05e7\u05e6\u05d5\u05e2\u05d9\u05ea")?6:c[b].Id_Categorie.includes("\u05e1\u05e0\u05d9\u05d5\u05e8\u05d9\u05dd")||c[b].Id_Categorie.includes("\u05e2\u05de\u05de\u05d9\u05ea")||c[b].Id_Categorie.includes("\u05d2'\u05d5\u05e0\u05d9\u05d5\u05e8 \u05de\u05e7\u05e6\u05d5\u05e2\u05d9")?5:c[b].Id_Categorie.includes("\u05de\u05ea\u05d7\u05d9\u05dc\u05d9\u05dd")||c[b].Id_Categorie.includes("\u05e1\u05d5\u05e4\u05e8 \u05d2'\u05d5\u05e0\u05d9\u05d5\u05e8")?
4:6);f=1==cleanResults?"":" slim";if(1==c[b].Id_Position&&"no"==useCategory||1==c[b].Id_PositionCategorie&&"yes"==useCategory){var u='<tr class="rnkh_bkcolor">\n';u=0==cleanResults?u+'<th colspan = "2" class="rnkh_font">&nbsp;&nbsp;\u05de\u05e7\u05d5\u05dd&nbsp;&nbsp;</th>\n':u+'<th class="rnkh_font">\u05de\u05e7\u05d5\u05dd</th>\n';u+='<th class="rnkh_font">\u05de\u05e1\u05e4\u05e8</th>\n';1==m&&"undefined"!=typeof c[b].Id_Licence?c[b].Id_Categorie.includes("\u05d0\u05d5\u05e4\u05e0\u05d5\u05e2\u05d9\u05dd")&&
"yes"==useCategory?u+='<th class="rnkh_font">\u05e9\u05dd</th>\n':(u+='<th class="rnkh_font">\u05e0\u05d4\u05d2</th>\n',u+='<th class="rnkh_font">\u05e0\u05d5\u05d5\u05d8</th>\n'):u+='<th class="rnkh_font">\u05e9\u05dd</th>\n';1==g&&0==x&&(u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d5\u05ea</th>\n');if(1==d&&c[b].Id_lap1)for(h=1;h<=G;h++)u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 '+h+"</th>\n";else 0==cleanResults&&(u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 \u05d0\u05d7\u05e8\u05d5\u05e0\u05d4</th>\n'),
u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 \u05de\u05d4\u05d9\u05e8\u05d4</th>\n';0==w&&0==x&&(u+='<th class="rnkh_font">\u05d6\u05de\u05df</th>\n');1==cleanResults&&(1==I&&"no"==useCategory||1==J[c[b].Id_Categorie]&&"yes"==useCategory)&&(u+='<th class="rnkh_font">\u05e2\u05d5\u05e0\u05e9\u05d9\u05df</th>\n');"yes"==useCategory?u+='<th class="rnkh_font">\u05e4\u05e2\u05e8</th>\n':"no"==useCategory&&(u+='<th class="rnkh_font">\u05e4\u05e2\u05e8</th>\n');u+="</tr>"}1==c[b].Id_Position&&(1==
firstPass&&(p[0].includes("_GreenFlag")||p[0].includes("_CheckeredFlag"))&&(firstPlace=c[b].Id_Numero),firstPlace!=c[b].Id_Numero&&0<c[b].Id_NbTour&&(p[0].includes("_GreenFlag")||p[0].includes("_CheckeredFlag"))&&(firstPlace=c[b].Id_Numero));e=c[b].Id_Numero;k=0;c[b].Id_Arrow="&#9670;";h="";c[b].Id_Image.includes("_Status10")?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dsq.svg" alt="dsq">',h="\u05e0\u05e4\u05e1\u05dc",doNotShowInTicker.includes(c[b].Id_Numero)||(ticker.push(t+" - "+c[b].Id_Nom+
" ("+c[b].Id_Numero+") \u05e0\u05e4\u05e1\u05dc"),doNotShowInTicker.push(c[b].Id_Numero))):c[b].Id_Image.includes("_Status11")||"_Status1"==c[b].Id_Image?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dnf.svg" alt="dnf">',h="\u05dc\u05d0 \u05e1\u05d9\u05d9\u05dd",doNotShowInTicker.includes(c[b].Id_Numero)||(ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e4\u05e8\u05e9"),doNotShowInTicker.push(c[b].Id_Numero))):c[b].Id_Image.includes("_Status12")?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dns.svg" alt="dns">',
...
k||positionArrayCat[e]&&"yes"==useCategory&&positionArrayCat[e]>k)c[b].Id_Arrow='<img class="postionChanged" src="Images/_PlusPosition.svg" alt="gained places">',n="gainedPosition ";1<Object.keys(q).length&&positionArrayAll[e]&&positionArrayCat[e]?(3>=c[b].Id_Position&&c[b].Id_Position<positionArrayAll[e]&&"???"!=c[b].Id_Nom&&0<c[b].Id_NbTour&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e2\u05dc\u05d4 \u05dc\u05de\u05e7\u05d5\u05dd "+c[b].Id_Position+" \u05db\u05dc\u05dc\u05d9"),3>=
c[b].Id_PositionCategorie&&c[b].Id_PositionCategorie<positionArrayCat[e]&&"???"!=c[b].Id_Nom&&0<c[b].Id_NbTour&&"undefined"!=c[b].Id_Categorie&&"&nbsp;"!=c[b].Id_Categorie&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e2\u05dc\u05d4 \u05dc\u05de\u05e7\u05d5\u05dd "+c[b].Id_PositionCategorie+" \u05d1\u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d4 "+c[b].Id_Categorie)):3>=c[b].Id_Position&&c[b].Id_Position<positionArrayAll[e]&&"???"!=c[b].Id_Nom&&0<c[b].Id_NbTour&&ticker.push(t+" - "+c[b].Id_Nom+
