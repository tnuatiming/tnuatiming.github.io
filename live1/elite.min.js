...
$jscomp.asyncExecutePromiseGenerator=function(a){function d(d){return a.next(d)}function g(d){return a.throw(d)}return new Promise(function(l,m){function v(a){a.done?l(a.value):Promise.resolve(a.value).then(d,g).then(v,m)}v(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.asyncExecutePromiseGeneratorProgram=function(a){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(a)))};
$jscomp.polyfill("Object.is",function(a){return a?a:function(a,g){return a===g?0!==a||1/a===1/g:a!==a&&g!==g}},"es6","es3");$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(a,g){var d=this;d instanceof String&&(d=String(d));var m=d.length;g=g||0;for(0>g&&(g=Math.max(g+m,0));g<m;g++){var v=d[g];if(v===a||Object.is(v,a))return!0}return!1}},"es7","es3");
...
function Load(a,d){var g,l,m,v,A,x,w,h,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:TimerLoad&&clearTimeout(TimerLoad);"yes"==useCategory?(document.getElementById("displayCatButton").style.display="none",document.getElementById("displayAllButton").style.display="block"):"no"==useCategory&&(document.getElementById("displayCatButton").style.display="block",document.getElementById("displayAllButton").style.display="none");if(!self.fetch){l=new XMLHttpRequest;
...
break}document.getElementById("categoryOrAll").style.display="block";document.getElementById("center1").style.display="block";v=document.getElementById(d);A=createLiveTable;return k.yield(m.text(),7);case 7:v.innerHTML=A(k.yieldResult),alignTable();case 6:k.leaveTryBlock(4);break;case 3:x=k.enterCatchBlock(),console.log("results fetch failed",x);case 4:return k.setCatchFinallyBlocks(8),k.yield(fetch("uploadMsg.txt",{cache:"no-store"}),10);case 10:w=k.yieldResult;if(!w.ok){k.jumpTo(11);break}h=document.getElementById("updates");
...
function createLiveTable(a){var d=0,g=1,l=1,m=0,v=0,A=0,x=0,w=0,h,e;var k=e=k=0;var b=[];var f=[];var c=[],E=0,H="99999999999",B="99999999999",F=[],r="&nbsp;";e=h=0;var n="";var C=6,G=6,D=0,y=1,I=0,J=[],K="",L="",M="";a=a.split("<table");a[1]=a[1].substring(a[1].indexOf("<tr"),a[1].lastIndexOf("</tr>")+5);n=a[1].split("\n");var p=a[0].split("\n"),t=document.createElement("div");t.innerHTML=p[0];k=t.textContent||t.innerText||"";y=k.split("-")[1].trim();t=p[1].split(":");t=("0"+t[0].slice(-2).trim()).slice(-2)+
":"+t[1];var q={};eventName!=k&&(doNotShowInTicker=[],ticker=[],firstPlace=flag="",tickerBestTime="-",categoryBestTimePrevious={},positionArrayAll={},positionArrayCat={});eventName=k;sessionStorage.setItem("eventName",eventName);a[0].includes("_GreenFlag")?(0==firstPass&&"green"!=flag&&ticker.push(t+" - \u05d6\u05d9\u05e0\u05d5\u05e7/\u05d3\u05d2\u05dc \u05d9\u05e8\u05d5\u05e7 "+y),flag="green"):a[0].includes("_CheckeredFlag")?(0==firstPass&&"checkered"!=flag&&ticker.push(t+" - \u05e1\u05d9\u05d5\u05dd "+
y),flag="checkered"):a[0].includes("_Stop")?(0==firstPass&&"checkered"!=flag&&ticker.push(t+" - \u05e1\u05d9\u05d5\u05dd"),flag="checkered"):a[0].includes("_RedFlag")?(0==firstPass&&"red"!=flag&&ticker.push(t+" - \u05d3\u05d2\u05dc \u05d0\u05d3\u05d5\u05dd"),flag="red"):a[0].includes("_YellowFlag")?(0==firstPass&&"yellow"!=flag&&ticker.push(t+" - \u05d3\u05d2\u05dc \u05e6\u05d4\u05d5\u05d1"),flag="yellow"):flag="";if(p[0].includes("\u05d8\u05e1\u05d8")||p[0].includes("\u05e1\u05e4\u05d9\u05d9\u05e9\u05dc"))d=
v=1,g=0;if(p[0].includes("\u05e1\u05e7\u05e8\u05de\u05d1\u05dc")||p[0].includes("\u05d4\u05d9\u05d9\u05e8"))A=1;p[0].includes("\u05e8\u05d0\u05dc\u05d9")&&p[0].includes("\u05e1\u05e4\u05e8\u05d9\u05e0\u05d8")&&(x=1,l=0);p[0].includes("laps")&&(D=p[0].substring(p[0].indexOf("laps")-1,p[0].indexOf("laps")),d=1,g=0,G=C=D,k=k.replace(D+"laps",""),D=1);if(p[0].includes("\u05d3\u05d9\u05e8\u05d5\u05d2")||p[0].includes("\u05d3\u05e8\u05d5\u05d2"))w=1,l=0;p[0].includes("+++")?(cleanResults=1,k=k.replace("+++",
...
b.push(y);else if(n[k].includes("OddRow")||n[k].includes("EvenRow"))h=1;else if(n[k].includes("</tr>")&&1==h)h=0,1==f.Id_TpsCumule_Penalty&&(J[f.Id_Categorie]=1),"undefined"==typeof q[f.Id_Categorie]&&(q[f.Id_Categorie]=[Number(99999999),"-","-"]),q[f.Id_Categorie][0]>timeString2ms(f.Id_MeilleurTour)&&"-"!=f.Id_MeilleurTour&&"&nbsp;"!=f.Id_Categorie&&(q[f.Id_Categorie]=[Number(timeString2ms(f.Id_MeilleurTour)),f.Id_Numero,f.Id_Nom]),B>timeString2ms(f.Id_MeilleurTour)&&(B=timeString2ms(f.Id_MeilleurTour)),
...
1,n[k].lastIndexOf("<")).replace("(C) ",""):"-";n[k].includes("BestTimeOverall")&&"Id_TpsTour"==b[e]?F[f.Id_Numero]=" BestTimeOverall":n[k].includes("BestTime")&&"Id_TpsTour"==b[e]?F[f.Id_Numero]=" BestTime":"Id_TpsTour"==b[e]&&(F[f.Id_Numero]="");"Id_Categorie"!=b[e]||"-"!=f[b[e]]&&""!=f[b[e]]&&"&nbsp;"!=f[b[e]]&&"undefined"!=typeof f[b[e]]||(f[b[e]]="&nbsp;");1==d&&("Id_TpsTour1"==b[e]||"Id_TpsTour2"==b[e]||"Id_TpsTour3"==b[e]||"Id_TpsTour4"==b[e]||"Id_TpsTour5"==b[e]||"Id_TpsTour6"==b[e])&&"-"!=
f[b[e]]&&timeString2ms(f[b[e]])<=timeString2ms(H)&&(H=f[b[e]],E=f.Id_Numero);e+=1}"yes"==useCategory&&p[0].includes("\u05d0\u05e0\u05d3\u05d5\u05e8\u05d5")?c.sort(function(a,b){return("&nbsp;"==a.Id_Categorie)-("&nbsp;"==b.Id_Categorie)||b.Id_Categorie.includes("\u05de\u05e7\u05e6\u05d5\u05e2\u05d9\u05ea")-a.Id_Categorie.includes("\u05de\u05e7\u05e6\u05d5\u05e2\u05d9\u05ea")||b.Id_Categorie.includes("\u05e2\u05de\u05de\u05d9\u05ea")-a.Id_Categorie.includes("\u05e2\u05de\u05de\u05d9\u05ea")||b.Id_Categorie.includes("\u05e1\u05e0\u05d9\u05d5\u05e8\u05d9\u05dd")-
...
(c[b].Id_Ecart1erCategorie=c[b].Id_Ecart1erCategorie.substr(1)));"undefined"!=typeof c[b].Id_TpsCumule&&"-"!=c[b].Id_TpsCumule&&("00:"==c[b].Id_TpsCumule.toString().substring(0,3)&&(c[b].Id_TpsCumule=c[b].Id_TpsCumule.substr(3)),"0"==c[b].Id_TpsCumule.toString().substring(0,1)&&c[b].Id_TpsCumule.includes(":")&&(c[b].Id_TpsCumule=c[b].Id_TpsCumule.substr(1)),c[b].Id_TpsCumule=c[b].Id_TpsCumule.replace(" 00:"," "));if(c[b].Id_TpsTour1&&1==d)for(h=f=C;-1<h;h--)if(c[b]["Id_TpsTour"+h]&&"-"!=c[b]["Id_TpsTour"+
h]||0==h){e=h;for(h=1;h<=f;h++)c[b]["Id_lap"+h]=0<e?c[b]["Id_TpsTour"+e]:"-",e--;h=-1}1==v&&"yes"==useCategory&&0==D&&(G=c[b].Id_Categorie.includes("\u05de\u05e7\u05e6\u05d5\u05e2\u05d9\u05ea")?6:c[b].Id_Categorie.includes("\u05e1\u05e0\u05d9\u05d5\u05e8\u05d9\u05dd")||c[b].Id_Categorie.includes("\u05e2\u05de\u05de\u05d9\u05ea")||c[b].Id_Categorie.includes("\u05d2'\u05d5\u05e0\u05d9\u05d5\u05e8 \u05de\u05e7\u05e6\u05d5\u05e2\u05d9")?5:c[b].Id_Categorie.includes("\u05de\u05ea\u05d7\u05d9\u05dc\u05d9\u05dd")||
c[b].Id_Categorie.includes("\u05e1\u05d5\u05e4\u05e8 \u05d2'\u05d5\u05e0\u05d9\u05d5\u05e8")?4:6);f=1==cleanResults?"":" slim";if(1==c[b].Id_Position&&"no"==useCategory||1==c[b].Id_PositionCategorie&&"yes"==useCategory){var u='<tr class="rnkh_bkcolor">\n';u=0==cleanResults?u+'<th colspan = "2" class="rnkh_font">&nbsp;&nbsp;\u05de\u05e7\u05d5\u05dd&nbsp;&nbsp;</th>\n':u+'<th class="rnkh_font">\u05de\u05e7\u05d5\u05dd</th>\n';u+='<th class="rnkh_font">\u05de\u05e1\u05e4\u05e8</th>\n';1==m&&"undefined"!=
typeof c[b].Id_Licence?c[b].Id_Categorie.includes("\u05d0\u05d5\u05e4\u05e0\u05d5\u05e2\u05d9\u05dd")&&"yes"==useCategory?u+='<th class="rnkh_font">\u05e9\u05dd</th>\n':(u+='<th class="rnkh_font">\u05e0\u05d4\u05d2</th>\n',u+='<th class="rnkh_font">\u05e0\u05d5\u05d5\u05d8</th>\n'):u+='<th class="rnkh_font">\u05e9\u05dd</th>\n';1==g&&0==x&&(u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d5\u05ea</th>\n');if(1==d&&c[b].Id_lap1)for(h=1;h<=G;h++)u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 '+
h+"</th>\n";else 0==cleanResults&&(u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 \u05d0\u05d7\u05e8\u05d5\u05e0\u05d4</th>\n'),u+='<th class="rnkh_font">\u05d4\u05e7\u05e4\u05d4 \u05de\u05d4\u05d9\u05e8\u05d4</th>\n';0==w&&0==x&&(u+='<th class="rnkh_font">\u05d6\u05de\u05df</th>\n');1==cleanResults&&(1==I&&"no"==useCategory||1==J[c[b].Id_Categorie]&&"yes"==useCategory)&&(u+='<th class="rnkh_font">\u05e2\u05d5\u05e0\u05e9\u05d9\u05df</th>\n');"yes"==useCategory?u+='<th class="rnkh_font">\u05e4\u05e2\u05e8</th>\n':
"no"==useCategory&&(u+='<th class="rnkh_font">\u05e4\u05e2\u05e8</th>\n');u+="</tr>"}1==c[b].Id_Position&&(1==firstPass&&(p[0].includes("_GreenFlag")||p[0].includes("_CheckeredFlag"))&&(firstPlace=c[b].Id_Numero),firstPlace!=c[b].Id_Numero&&0<c[b].Id_NbTour&&(p[0].includes("_GreenFlag")||p[0].includes("_CheckeredFlag"))&&(firstPlace=c[b].Id_Numero));e=c[b].Id_Numero;k=0;c[b].Id_Arrow="&#9670;";h="";c[b].Id_Image.includes("_Status10")?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dsq.svg" alt="dsq">',
h="\u05e0\u05e4\u05e1\u05dc",doNotShowInTicker.includes(c[b].Id_Numero)||(ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e0\u05e4\u05e1\u05dc"),doNotShowInTicker.push(c[b].Id_Numero))):c[b].Id_Image.includes("_Status11")||"_Status1"==c[b].Id_Image?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dnf.svg" alt="dnf">',h="\u05dc\u05d0 \u05e1\u05d9\u05d9\u05dd",doNotShowInTicker.includes(c[b].Id_Numero)||(ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e4\u05e8\u05e9"),doNotShowInTicker.push(c[b].Id_Numero))):
c[b].Id_Image.includes("_Status12")?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_dns.svg" alt="dns">',h="\u05dc\u05d0 \u05d4\u05ea\u05d7\u05d9\u05dc"):c[b].Id_Image.includes("_Status2")?(c[b].Id_Arrow='<img class="dnsfq" src="Images/_nq.svg" alt="nq">',h="\u05dc\u05dc\u05d0 \u05d3\u05d9\u05e8\u05d5\u05d2"):c[b].Id_Image.includes("_Status")?c[b].Id_Arrow='<img class="dnsfq" src="Images/_status.svg" alt="status">':c[b].Id_Arrow="&#9670;";c[b].Id_Position&&"no"==useCategory&&(k=Number(c[b].Id_Position));
c[b].Id_PositionCategorie&&"yes"==useCategory&&(k=Number(c[b].Id_PositionCategorie));n="";0==c[b].Id_NbTour&&(positionArrayAll[e]="999",positionArrayCat[e]="999");if(0<k&&0<=e&&("-"!=c[b].Id_TpsTour||0<c[b].Id_NbTour||c[b].Id_Image.includes("_TrackPassing"))&&(0<c[b].Id_NbTour||1==w&&"-"!=c[b].Id_TpsTour))if(positionArrayAll[e]&&"no"==useCategory&&positionArrayAll[e]<k||positionArrayCat[e]&&"yes"==useCategory&&positionArrayCat[e]<k)c[b].Id_Arrow='<img class="postionChanged" src="Images/_MinusPosition.svg" alt="lost places">',
n="lostPosition ";else if(positionArrayAll[e]&&"no"==useCategory&&positionArrayAll[e]>k||positionArrayCat[e]&&"yes"==useCategory&&positionArrayCat[e]>k)c[b].Id_Arrow='<img class="postionChanged" src="Images/_PlusPosition.svg" alt="gained places">',n="gainedPosition ";1<Object.keys(q).length&&positionArrayAll[e]&&positionArrayCat[e]?(3>=c[b].Id_Position&&c[b].Id_Position<positionArrayAll[e]&&"???"!=c[b].Id_Nom&&0<c[b].Id_NbTour&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e2\u05dc\u05d4 \u05dc\u05de\u05e7\u05d5\u05dd "+
c[b].Id_Position+" \u05db\u05dc\u05dc\u05d9"),3>=c[b].Id_PositionCategorie&&c[b].Id_PositionCategorie<positionArrayCat[e]&&"???"!=c[b].Id_Nom&&0<c[b].Id_NbTour&&"undefined"!=c[b].Id_Categorie&&"&nbsp;"!=c[b].Id_Categorie&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e2\u05dc\u05d4 \u05dc\u05de\u05e7\u05d5\u05dd "+c[b].Id_PositionCategorie+" \u05d1\u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d4 "+c[b].Id_Categorie)):3>=c[b].Id_Position&&c[b].Id_Position<positionArrayAll[e]&&"???"!=c[b].Id_Nom&&
0<c[b].Id_NbTour&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05e2\u05dc\u05d4 \u05dc\u05de\u05e7\u05d5\u05dd "+c[b].Id_Position);positionArrayAll[e]=c[b].Id_Position;positionArrayCat[e]=c[b].Id_PositionCategorie;c[b].Id_NbTour&&(k=c[b].Id_NbTour,k!=lapsArray[e]&&""==n&&0==firstPass&&(n="unChanged "),lapsArray[e]=k);""!=n&&"unChanged "!=n||!c[b].Id_Image.includes("_TrackPassing")&&"1"!=c[b].Id_Canal||c[b].Id_Image.includes("_Status")||(c[b].Id_Arrow='<img class="postionSame" src="Images/_TrackPassing.svg" alt="same places">');
"1"==c[b].Id_PositionCategorie&&"yes"==useCategory?("&nbsp;"!=r&&"undefined"!=typeof q[r][1]&&1==l&&"&nbsp;"!=r&&"\u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d4 \u05db\u05dc\u05dc\u05d9\u05ea"!=r&&"-"!=q[r][1]&&(e=ms2TimeString(Number(q[r][0])),"00:"==e.toString().substring(0,3)&&(e=e.substr(3)),"0"==e.toString().substring(0,1)&&e.includes(":")&&(e=e.substr(1)),a+='<tr><td colspan="99" class="comment_font">\u05d4\u05e7\u05e4\u05d4 \u05de\u05d4\u05d9\u05e8\u05d4: ('+q[r][1]+") "+q[r][2]+" - "+e+"</td></tr>\n"),
r=c[b].Id_Categorie,a+='<table class="'+tableClass+'line_color">\n<tr><td colspan="99" class="title_font">'+c[b].Id_Categorie+"</td></tr>"+u+"\n"):1==c[b].Id_Position&&"no"==useCategory&&(a+='<tr><td colspan="99" class="title_font">\u05db\u05dc\u05dc\u05d9</td></tr>'+u+"\n");!c[b].Id_Image.includes("_Status11")&&"_Status1"!=c[b].Id_Image||"yes"!=useCategory||K==r||1!=cleanResults?c[b].Id_Image.includes("_Status10")&&"yes"==useCategory&&M!=r&&1==cleanResults?(a+='<tr><td colspan="99" class="subtitle_font">\u05e0\u05e4\u05e1\u05dc - DSQ</td></tr>\n',
M=r):c[b].Id_Image.includes("_Status12")&&"yes"==useCategory&&L!=r&&1==cleanResults&&(a+='<tr><td colspan="99" class="subtitle_font">\u05dc\u05d0 \u05d4\u05ea\u05d7\u05d9\u05dc - DNS</td></tr>\n',L=r):(a+='<tr><td colspan="99" class="subtitle_font">\u05dc\u05d0 \u05e1\u05d9\u05d9\u05dd - DNF</td></tr>\n',K=r);1==cleanResults&&(n="");a=0==b%2?a+('<tr class="'+n+'rnk_bkcolor OddRow">\n'):a+('<tr class="'+n+'rnk_bkcolor EvenRow">\n');e=0;1==A&&(e=c[b].Id_Categorie.toUpperCase().includes("E")&&timeString2ms(c[b].Id_TpsCumule)>=
...
timeString2ms(c[b].Id_TpsCumule)>=harescrambleFinishC?1:0);e=c[b].Id_Image.includes("_CheckeredFlag")||!c[b].Id_Image.includes("_Status")&&1==d&&(c[b].Id_Image.includes("_CheckeredFlag")||c[b].Id_NbTour==C||1==v&&c[b].Id_NbTour==C-2&&c[b].Id_Categorie.includes("\u05de\u05ea\u05d7\u05d9\u05dc\u05d9\u05dd")||1==v&&c[b].Id_NbTour==C-1&&!c[b].Id_Categorie.toUpperCase().includes("E"))?"finished ":c[b].Id_Image.includes("_Status")||1!=e?"":"finished ";0==cleanResults&&(a=c[b].Id_Arrow.includes("dnsfq")?
...
f]+"</td>\n"):1==l&&"-"!=c[b]["Id_lap"+f]&&c[b]["Id_lap"+f]==c[b].Id_MeilleurTour?a+('<td class="rnk_font BestTime">'+c[b]["Id_lap"+f]+"</td>\n"):a+('<td class="rnk_font">'+c[b]["Id_lap"+f]+"</td>\n");else 0==cleanResults&&(a+='<td class="rnk_font'+F[c[b].Id_Numero]+'">'+c[b].Id_TpsTour+"</td>\n"),a+='<td class="rnk_font">'+c[b].Id_MeilleurTour+"</td>\n";timeString2ms(c[b].Id_MeilleurTour)==B&&tickerBestTime!=B&&"???"!=c[b].Id_Nom&&"&nbsp;"!=c[b].Id_Categorie&&(tickerBestTime=B,f=ms2TimeString(tickerBestTime),
"00:"==f.toString().substring(0,3)&&(f=f.substr(3)),"0"==f.toString().substring(0,1)&&f.includes(":")&&(f=f.substr(1)),0==firstPass&&ticker.push(t+" - "+c[b].Id_Nom+" ("+c[b].Id_Numero+") \u05d4\u05e7\u05e4\u05d4 \u05de\u05d4\u05d9\u05e8\u05d4 \u05db\u05dc\u05dc\u05d9\u05ea - "+f));1==I&&1==cleanResults&&("no"==useCategory||"yes"==useCategory&&1==J[c[b].Id_Categorie])?0==w&&0==x&&(a="undefined"!=typeof c[b].Id_TpsCumule?1==c[b].Id_TpsCumule_Penalty?a+('<td class="rnk_font penalty">P '+c[b].Id_TpsCumule+
...
categoryBestTimePrevious[z][0]&&"&nbsp;"!=z&&"???"!=q[z][2]&&(e=ms2TimeString(Number(q[z][0])),"00:"==e.toString().substring(0,3)&&(e=e.substr(3)),"0"==e.toString().substring(0,1)&&e.includes(":")&&(e=e.substr(1)),ticker.push(t+" - "+q[z][2]+" ("+q[z][1]+") \u05d4\u05e7\u05e4\u05d4 \u05de\u05d4\u05d9\u05e8\u05d4 \u05d1\u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d4 "+z+' - <span dir="ltr">'+e+"</span>"));categoryBestTimePrevious=q;tableClass="";if(document.getElementById("tickerTest"))if(1==firstPass&&
