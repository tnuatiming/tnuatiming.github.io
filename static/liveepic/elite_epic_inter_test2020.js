/* 20191001 - remove Id_Groupe, added Id_Club for uci, added new _Status (1 - leader, and statuss with blue) need to port to total and remote js.
 * 
 * 
*/
...
*/                    
                    ...
                    lineArray.Id_Image_2 = "";
                    lineArray.Id_Club_2 = ""; // uci Yes/No
...
//                    }
                    ...
                    if (lineArray["Id_Club"].toLowerCase() != 'yes') {
                        lineArray["Id_Club"] = "No";   
                    }
...
//          console.log(lineArray);
     ...
     //    console.log(allArray);
        ...
        for (let b = 0; b < allArray.length; b++) {  // main array
//            for (let a = 0; a < allArray2.length; a++) {  // replaced allArray2[a] with allArray2obj[allArray[b]["Id_Numero"]]
...
//                    if (allArray[b]["Id_Groupe"].includes('u') && allArray2obj[allArray[b]["Id_Numero"]]["Id_Groupe"].includes('u')) {
                    if (allArray[b]["Id_Club"] == 'Yes' && allArray2obj[allArray[b]["Id_Numero"]]["Id_Club_2"] == 'Yes') {
...
//                        allArray2obj[allArray[b]["Id_Numero"]]["Id_Groupe"] = allArray2obj[allArray[b]["Id_Numero"]]["Id_Groupe"].replace('u', '');
                    ...
                    } else if (allArray[b]["Id_Club"] == 'Yes' && !(allArray2obj[allArray[b]["Id_Numero"]]["Id_Club_2"] == 'Yes')) {
...
*/
                    ...
                    if (allArray[b]["Id_Image"] == '_Status1' || allArray2obj[allArray[b]["Id_Numero"]]["Id_Image_2"] == '_Status1') {
                        
                        allArray[b]["leader"] = 1; // mark leader (yellow shirt)
                        
                    }
                    // FIXME find way to mark israeli leader: allArray[b]["leader"] = 2
                    ...
                    allArray[b]["Id_Club_2"] = allArray2obj[allArray[b]["Id_Numero"]]["Id_Club"];   
...
// check status for individual finisher
                        if (allArray[b]["Id_Image_2"] == '_Status6') {
                            allArray[b]["single"] = 2;
                        } else if (allArray[b]["Id_Image"] == '_Status6') {
                            allArray[b]["single"] = 1;
                        }
...
*/                            
 ...
 // make blue if exceed MaximumStageTime, ENABLE after testing
                        allArray[b].mst = 0;
                        if (allArray[b]["Id_Image"] == "_Status3" || allArray[b]["Id_Image_2"] == "_Status3") {
                            allArray[b]["mst"] = 1;
                            if (show == 4) {
                                allArray[b]["blue"] = 1;
                            }
...
// select all status that make blue FIXME need solution to differ blue and oldblue
                    if (allArray[b]["Id_Image"] == '_Status3' || allArray[b]["Id_Image"] == '_Status4' || allArray[b]["Id_Image"] == '_Status5' || allArray[b]["Id_Image"] == '_Status7' || allArray[b]["Id_Image"] == '_Status8' || allArray[b]["Id_Image"] == '_Status9' || allArray[b]["Id_Image_2"] == '_Status3' || allArray[b]["Id_Image_2"] == '_Status4' ||  allArray[b]["Id_Image_2"] == '_Status5' ||  allArray[b]["Id_Image_2"] == '_Status7' ||  allArray[b]["Id_Image_2"] == '_Status8' ||  allArray[b]["Id_Image_2"] == '_Status9') {                    
                        allArray[b]["oldBlue"] = 1;
                    }
         

                if (allArray[b]["Id_Image"] == "_Status6" || allArray[b]["Id_Image_2"] == "_Status6" || allArray[b]["Id_Image"] == "_Status1" || allArray[b]["Id_Image_2"] == "_Status1") {
...
//          allArray.sort(function(a, b){return (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie.includes("Masters"))-(a.Id_Categorie.includes("Masters")) || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi1 - b.Id_Statusi1 || a.oldBlue - b.oldBlue || a.single - b.single || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie == "Masters")-(a.Id_Categorie == "Masters") || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi1 - b.Id_Statusi1 || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//            allArray.sort(function(a, b){return a.Id_Statusi1 - b.Id_Statusi1 || a.oldBlue - b.oldBlue || a.single - b.single || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => a.Id_Statusi1 - b.Id_Statusi1 || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//            allArray.sort(function(a, b){return (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie.includes("Masters"))-(a.Id_Categorie.includes("Masters")) || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi2 - b.Id_Statusi2 || a.oldBlue - b.oldBlue || a.single - b.single || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie == "Masters")-(a.Id_Categorie == "Masters") || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi2 - b.Id_Statusi2 || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//            allArray.sort(function(a, b){return a.Id_Statusi2 - b.Id_Statusi2 || a.oldBlue - b.oldBlue || a.single - b.single || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => a.Id_Statusi2 - b.Id_Statusi2 || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//            allArray.sort(function(a, b){return (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie.includes("Masters"))-(a.Id_Categorie.includes("Masters")) || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi3 - b.Id_Statusi3 || a.oldBlue - b.oldBlue || a.single - b.single || a.Id_Inter3blue - b.Id_Inter3blue || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter3Time - b.Id_Inter3Time || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => (b.Id_Categorie.includes("Men"))-(a.Id_Categorie.includes("Men")) || (b.Id_Categorie.includes("Women"))-(a.Id_Categorie.includes("Women")) || (b.Id_Categorie.includes("Mixed"))-(a.Id_Categorie.includes("Mixed")) || (b.Id_Categorie == "Masters")-(a.Id_Categorie == "Masters") || a.Id_Categorie.localeCompare(b.Id_Categorie) || a.Id_Statusi3 - b.Id_Statusi3 || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.Id_Inter3blue - b.Id_Inter3blue || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter3Time - b.Id_Inter3Time || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//            allArray.sort(function(a, b){return a.Id_Status - b.Id_Status || a.oldBlue - b.oldBlue || a.single - b.single || a.oldBlue - b.oldBlue || a.Id_Inter3blue - b.Id_Inter3blue || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter3Time - b.Id_Inter3Time || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2});
            ...
            allArray.sort((a, b) => a.Id_Status - b.Id_Status || a.oldBlue - b.oldBlue || (a.single != 0) - (b.single != 0) || a.oldBlue - b.oldBlue || a.Id_Inter3blue - b.Id_Inter3blue || a.Id_Inter2blue - b.Id_Inter2blue || a.Id_Inter1blue - b.Id_Inter1blue || a.Id_Inter3Time - b.Id_Inter3Time || a.Id_Inter2Time - b.Id_Inter2Time || a.Id_Inter1Time - b.Id_Inter1Time || a.Id_TpsCumule - b.Id_TpsCumule || a.Id_TpsCumule_2 - b.Id_TpsCumule_2);
...
//                    headerText1 += '<th colspan="2" class="rnkh_font Id_Position"><div>Cat</div><div>GC</div></th>';
                    headerText1 += '<th class="rnkh_font Id_Position">Overall Position</th>'; // overall
...
// remove for kellner                                if (competitorLaps == leaderLaps) {
                    ...
                    if (typeof positionArray_All_Cat[allArray[l]["Id_Numero"]] != 'undefined' && useCategory == "no" && allArray[l]["Id_Sector_FinishTime"] != 99999999999 && allArray[l]["Id_Status"] == 0) {
                    ...
                    } else if (typeof positionArray_All_Cat[allArray[l]["Id_Numero"]] != 'undefined' && useCategory == "yes" && allArray[l]["Id_Sector_FinishTime"] != 99999999999 && allArray[l]["Id_Status"] == 0) {
...
*/                } else if (useKellner == 1 && allArray[l]["Id_FinishTime"] == 99999999999 && allArray[l]["Id_Status"] == 0) { // check on track using kellner
                ...
                } else if (raceEnded == 1 && allArray[l]["Id_FinishTime"] == 99999999999 && show == 4 && (allArray[l]["Id_TpsCumule"] != 99999999999 || allArray[l]["Id_TpsCumule_2"] != 99999999999) && allArray[l]["Id_Status"] == 0) { // check  IF if race ended (only for display)
                ...
                } else if (allArray[l]["Id_Status"] == 1 || allArray[l]["Id_Sector_FinishTime"] == 99999999999 || allArray[l]["oldBlue"] == 1 || showBlue == 1 || allArray[l]["single"] != 0 || (show != 4 && ((show >= 1 && allArray[l]["Id_Inter1blue"] == 1) || (show >= 2 && allArray[l]["Id_Inter2blue"] == 1) || (show >= 3 && allArray[l]["Id_Inter3blue"] == 1)))) { // enable show != 4, to show postion only on finish
...
// 12 '<img class="dnsfq" src="Images/_dns.svg" alt="dns">'                    
                ...
                if (allArray[l]["Id_Status"] == 1 || allArray[l]["Id_Sector_FinishTime"] == 99999999999 || allArray[l]["oldBlue"] == 1 || showBlue == 1 || allArray[l]["single"] != 0) {
...
//                finalText += '<td class="rnk_font">' + allArray[l]["Id_Groupe"].replace(/u/g, '').replace('d', 'DSQ').replace('l', 'Leader').replace('b', 'Blue').replace('s', 'IF').replace(/[0-9]/g, '') + '</td>'; // start status
...
//                finalText += '<td class="rnk_font">' + allArray[l]["Id_Groupe"].replace(/u/g, '').replace('d', 'DSQ').replace('l', 'Leader').replace('b', 'Blue').replace('s1', 'IF1').replace('s2', 'IF2').replace(/[0-9]/g, '') + '</td>'; // start status
...
//        delete allArray[l].Id_Groupe;
        ...
        allArray[l].u1 = allArray[l].Id_Club;
        delete allArray[l].Id_Club;
        allArray[l].u2 = allArray[l].Id_Club_2;
        delete allArray[l].Id_Club_2;
