...
//                delete allArray4[b].G;
                ...
                if (allArray4[b]["Id_Image"] == '_Status6') {

                    allArray4[b]["single"] = 1;

                } else if (allArray4[b]["Id_Image_2"] == '_Status6') {
...
//                if (allArray4[b]["Id_Groupe"].includes('b')) {                    
                if (allArray4[b]["Id_Image"] == '_Status3' || allArray4[b]["Id_Image"] == '_Status4' || allArray4[b]["Id_Image"] == '_Status5' || allArray4[b]["Id_Image"] == '_Status7' || allArray4[b]["Id_Image"] == '_Status8' || allArray4[b]["Id_Image"] == '_Status9' || allArray4[b]["Id_Image_2"] == '_Status3' || allArray4[b]["Id_Image_2"] == '_Status4' ||  allArray4[b]["Id_Image_2"] == '_Status5' ||  allArray4[b]["Id_Image_2"] == '_Status7' ||  allArray4[b]["Id_Image_2"] == '_Status8' ||  allArray4[b]["Id_Image_2"] == '_Status9') {                    
...
//                }
                ...
                // mark unclassified
                if (allArray4[b]["Id_Image"] == "_Status6" || allArray4[b]["Id_Image_2"] == "_Status6" || allArray4[b]["Id_Image"] == "_Status1" || allArray4[b]["Id_Image_2"] == "_Status1") {
                    allArray4[b].Id_Status = 0;
                } else if (allArray4[b]["Id_Image"].includes("_Status") || allArray4[b]["Id_Image_2"].includes("_Status")){
                ...
                if (allArray4[b]["blue"] == 1 || allArray4[b]["Id_Status"] == 1 || allArray4[b]["Id_Arrow"] == 12 || allArray4[b]["Id_Arrow"] == 11 || allArray4[b]["Id_Arrow"] == 10 || allArray4[b]["Id_FinishTime"] == 99999999999 || allArray4[b]["single"] != 0) {
                    allArray4[b]["out"] = 1;
                } else {
                    allArray4[b]["out"] = 0;
                }
...
//                delete allArray3[b].G;
                ...
                if (allArray3[b]["Id_Image"] == '_Status6') {

                    allArray3[b]["single"] = 1;

                } else if (allArray3[b]["Id_Image_2"] == '_Status6') {
...
//                if (allArray3[b]["Id_Groupe"].includes('b')) {                    
                if (allArray3[b]["Id_Image"] == '_Status3' || allArray3[b]["Id_Image"] == '_Status4' || allArray3[b]["Id_Image"] == '_Status5' || allArray3[b]["Id_Image"] == '_Status7' || allArray3[b]["Id_Image"] == '_Status8' || allArray3[b]["Id_Image"] == '_Status9' || allArray3[b]["Id_Image_2"] == '_Status3' || allArray3[b]["Id_Image_2"] == '_Status4' ||  allArray3[b]["Id_Image_2"] == '_Status5' ||  allArray3[b]["Id_Image_2"] == '_Status7' ||  allArray3[b]["Id_Image_2"] == '_Status8' ||  allArray3[b]["Id_Image_2"] == '_Status9') {                    
...
//                }
                ...
                // mark unclassified
                if (allArray3[b]["Id_Image"] == "_Status6" || allArray3[b]["Id_Image_2"] == "_Status6" || allArray3[b]["Id_Image"] == "_Status1" || allArray3[b]["Id_Image_2"] == "_Status1") {
                    allArray3[b].Id_Status = 0;
                } else if (allArray3[b]["Id_Image"].includes("_Status") || allArray3[b]["Id_Image_2"].includes("_Status")){
                ...
                if (allArray3[b]["blue"] == 1 || allArray3[b]["Id_Status"] == 1 || allArray3[b]["Id_Arrow"] == 12 || allArray3[b]["Id_Arrow"] == 11 || allArray3[b]["Id_Arrow"] == 10 || allArray3[b]["Id_FinishTime"] == 99999999999 || allArray3[b]["single"] != 0) {
                    allArray3[b]["out"] = 1;
                } else {
                    allArray3[b]["out"] = 0;
                }
...
//                delete allArray2[b].G;
                ...
                if (allArray2[b]["Id_Image"] == '_Status6') {

                    allArray2[b]["single"] = 1;

                } else if (allArray2[b]["Id_Image_2"] == '_Status6') {
...
//                if (allArray2[b]["Id_Groupe"].includes('b')) {                    
                if (allArray2[b]["Id_Image"] == '_Status3' || allArray2[b]["Id_Image"] == '_Status4' || allArray2[b]["Id_Image"] == '_Status5' || allArray2[b]["Id_Image"] == '_Status7' || allArray2[b]["Id_Image"] == '_Status8' || allArray2[b]["Id_Image"] == '_Status9' || allArray2[b]["Id_Image_2"] == '_Status3' || allArray2[b]["Id_Image_2"] == '_Status4' ||  allArray2[b]["Id_Image_2"] == '_Status5' ||  allArray2[b]["Id_Image_2"] == '_Status7' ||  allArray2[b]["Id_Image_2"] == '_Status8' ||  allArray2[b]["Id_Image_2"] == '_Status9') {                    
...
//                }
                ...
                // mark unclassified
                if (allArray2[b]["Id_Image"] == "_Status6" || allArray2[b]["Id_Image_2"] == "_Status6" || allArray2[b]["Id_Image"] == "_Status1" || allArray2[b]["Id_Image_2"] == "_Status1") {
                    allArray2[b].Id_Status = 0;
                } else if (allArray2[b]["Id_Image"].includes("_Status") || allArray2[b]["Id_Image_2"].includes("_Status")){
                ...
                if (allArray2[b]["blue"] == 1 || allArray2[b]["Id_Status"] == 1 || allArray2[b]["Id_Arrow"] == 12 || allArray2[b]["Id_Arrow"] == 11 || allArray2[b]["Id_Arrow"] == 10 || allArray2[b]["Id_FinishTime"] == 99999999999 || allArray2[b]["single"] != 0) {
                    allArray2[b]["out"] = 1;
                } else {
                    allArray2[b]["out"] = 0;
                }
...
//                delete allArray[b].G;
                ...
                allArray[b].Id_Club = allArray[b].u1; // uci
                delete allArray[b].u1;
                allArray[b].Id_Club_2 = allArray[b].u2;
                delete allArray[b].u2;
...
//                delete allArray[b].TT;
                ...
                if (allArray[b]["Id_Image"] == '_Status6') {

                    allArray[b]["single"] = 1;

                } else if (allArray[b]["Id_Image_2"] == '_Status6') {
                ...
                if (allArray[b]["Id_Club"].toLowerCase() == 'yes' && allArray[b]["Id_Club_2"].toLowerCase() == 'yes') {

                    allArray[b]["uci"] = 3;

                } else if (allArray[b]["Id_Club"].toLowerCase() == 'yes') {

                    allArray[b]["uci"] = 1;

                } else if (allArray[b]["Id_Club_2"].toLowerCase() == 'yes') {
...
//                }
                ...
                if (allArray[b]["blue"] == 1 || allArray[b]["Id_Status"] == 1 || allArray[b]["Id_Arrow"] == 12 || allArray[b]["Id_Arrow"] == 11 || allArray[b]["Id_Arrow"] == 10 || allArray[b]["Id_FinishTime"] == 99999999999 || allArray[b]["single"] != 0) {
                    allArray[b]["out"] = 1;
                } else {
                    allArray[b]["out"] = 0;                    
                }
 ...
 // HEADER for tv            
   ...
   //     }          
                ...
                if (/*showArrow == 1*/ showTvHeader == 0) {
                    ...
                    TVheaderText1 += '<th class="rnkh_font right finishTimeTotal">Time</th>'; // combined time
