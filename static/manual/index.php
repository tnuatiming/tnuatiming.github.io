...
<h2 id="C1" class="c4">תוכנות</h2>
    ...
    <p class="c3"><span class="c6"><a class="c2" href="http://tnuatiming.com/software/ProtocolDecoder.pdf">Protocol Decoder</a></span></p>
...
<p class="c0"><span>** יתכן ו-start time לא יופיע בכפתור הימני בעכבר. יש לבחור בתפריט Competitors > Assign starting schedules. יש לבחור start time לפי ההיט, לבחור את כל המתחרים Apply , ctrl-a ולאשר.</span></p>
   ...
   <h2 id="C2" class="c4">יבוא מתחרים</h2>
    ...
    <li>שורת "קטגוריה" חייבת להופיע על מנת שתצוגת הקטגוריות תופעל.</li>
    ...
    <p class="c0">אם שם התיקיה/מרוץ כולל "מוטוקרוס" או "אנדורו" אז צבעי מספר המתחרה יופיעו לפי הקטגוריה אליה הוא שייך</p>
   
    <p class="c0">אם שם התיקיה/מרוץ כולל "ספיישל טסט" או אז יופיעו 6 הקפות</p>

    <p class="c0">אם שם התיקיה/מרוץ כולל "היירסקרמבל" או אז יופיע דגל שחמט לפי קטגוריה וזמן המתחרה(שעתיים למקצועית, שעה למתחילים וכו')</p>

    <p class="c0">אם שם התיקיה/מרוץ כולל "copilot" או אז תתוסף עמודה עבור "נווט"(ה-copilot לא יראה), אם שם הקטגוריה כולל "אופנועים" אז עמודת הנווט לא תופיע</p>

    <p class="c0">אם שם התיקיה/מרוץ כולל "דירוג" או אז יופיעו עמודות מתאימות למקצה דירוג</p>

    <p class="c0">אם שם התיקיה/מרוץ כולל "2laps" או אז יופיעו עמודות מתאימות למרוץ עם 2 הקפות כגון ראלי רייד  (יכול להיות כל מספר הקפות בין 2 ל-9)</p>

    <p class="c0">אם שם התיקיה/מרוץ כולל "nobestlap" או אז לא יופיע הקפה מהירה</p>

    <p class="c0">בכדי להראות עונשין יש להוסיף את שורת "עונשין - זמן" (total time penalty)</p>

    <p class="c0">כל התוספות באנגלית לעיל, לא יופיעו בתצוגת שם המרוץ באתר</p>
