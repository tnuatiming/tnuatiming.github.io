...
total - https://tnuatiming.com/liveepic/total.html on epic site, copy of tables generated by mastertotal.html (use publish button or use quick source viewer extension to get the tables, remove "fadeIn" except table tag), per day.

totalall - https://tnuatiming.com/liveepic/totalall.html on epic site, can view all days. uses publish box(q1.txt) generated by mastertotal.html
