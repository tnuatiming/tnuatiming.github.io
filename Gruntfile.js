  ...
  // Project configuration.
    grunt.initConfig({
        ...
        //        command: './convert_html_to_csv.sh'
            ...
            htmlproof: {
                command: 'htmlproofer ./_site --disable-external --check-html  --alt-ignore "/.*/" --trace --file-ignore "/liveepic/,/results/epic/,/live/"'
            },
        ...
        htmlmin: {                                     // Task 
            dist: {                                      // Target 
                ...
                files: [{                                   // Dictionary of files 
                    cwd: '_site',
                    src: ['**/*.html', '!csv/index.html', '!live/p1.html', '!live1/p1.html', '!liveepic/index.html', '!liveepic/p1.html', '!liveepic/stage1/p1.html', '!liveepic/stage2/p1.html', '!liveepic/stage3/p1.html', '!liveepic/stage4/p1.html', '!liveepic/p11.html', '!liveepic/p12.html', '!liveepic/backup/**', '!**/2013/*.html', '!**/2014/*.html', '!**/2015/*.html', '!**/2016/*.html', '!**/2017/*.html', '!**/2018/*.html', '!**/2019/*.html', '!backup/index.html' ],
                    dest: '_site',
        ...
        zip_directories: {
            backup: {
                files: [{
                    ...
                    src: ['_posts', 'content', 'layouts', '!hugo_backup', 'static/software', 'static/manual', 'static/images', 'static/live', 'static/live1', 'static/liveepic', 'static/livex', 'static/style', 'static/english', 'static/backup', '!node_modules','!assets', '!_site', '!log', '!archetypes', '!data', '!themes', '!.git']
                }]
            }
        },
